/**
 * Mobile Dashboard for Veridity App
 */
...
export function MobileDashboard({ user }: DashboardProps) {
  ...
  const generateProof = async (proofType: string) => {
    try {
      // Show loading state
      Alert.alert('Generating...', 'Creating your zero-knowledge proof');
      
      // Simulate proof generation
      setTimeout(() => {
        Alert.alert(
          'Success! 🎉', 
          `Your ${proofType.replace('_', ' ')} proof has been generated and can be used to verify your identity privately.`,
          [{ text: 'OK' }]
        );
  ...
  const handleVerifyProof = () => {
    ...
    Alert.alert(
      'Verify Proof', 
      'Scan a QR code or enter proof details to verify',
      [
        { text: 'Scan QR Code', onPress: () => scanQRCode() },
        { text: 'Enter Manually', onPress: () => enterProofManually() },
        { text: 'Cancel', style: 'cancel' }
      ]
    );
  };
  ...
  const enterProofManually = () => {
    Alert.alert('Manual Entry', 'Manual proof entry feature will be available soon');
  };

  const handleProofTypePress = (type: string) => {
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.proofTypesContainer}>
          ...
          <TouchableOpacity 
            style={styles.proofTypeCard} 
            onPress={() => handleProofTypePress('age_verification')}
            testID="card-age-verification"
          >
          ...
          <TouchableOpacity 
            style={styles.proofTypeCard} 
            onPress={() => handleProofTypePress('citizenship_verification')}
            testID="card-citizenship-verification"
          >
          ...
          <TouchableOpacity 
            style={styles.proofTypeCard} 
            onPress={() => handleProofTypePress('income_verification')}
            testID="card-income-verification"
          >
            <Text style={styles.proofTypeIcon}>💰</Text>
            <View style={styles.proofTypeInfo}>
          ...
          <TouchableOpacity 
            style={styles.proofTypeCard} 
            onPress={() => handleProofTypePress('education_verification')}
            testID="card-education-verification"
          >
            <Text style={styles.proofTypeIcon}>🎓</Text>
            <View style={styles.proofTypeInfo}>
